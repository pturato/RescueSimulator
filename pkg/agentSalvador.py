...
class AgentSalvador:
    ...
    def deliberate(self):
        ...
        if result == None:
            print("pvs: ", pvs(len(self.plan.vitimas_salvas), self.model.getNumberOfVictims()), "numero de vitimas encontradas: ", len(self.vitimas))
            print("tvs: ", tvs(self.costAll, len(self.plan.vitimas_salvas)))
            sinais = []
            #sinais_encontrados = []
            ...
            # #print("sinais: ", sinais)
            print("vsg: ", vsg(self.plan.vitimas_salvas, sinais))
            return -1
